...
def LOGO_other_elements():
    ...
    small_zombies_list = [small_enemie1_raw, small_enemie2_raw, small_enemie3_raw, small_enemie4_raw]
    medium_zombies_list = [medium_enemy1_raw, medium_enemy2_raw]
    all_zombies=small_zombies_list+medium_zombies_list

    for zombie_image in all_zombies:
        zombie_rect1 =zombie_image.get_rect(center=(random.randint(50, WIDTH - 50), int(random.choice([50, WIDTH - 50]))))
        zombie_rect2 =zombie_image.get_rect(center=( int(random.choice([50, HEIGHT - 50])),random.randint(50, HEIGHT - 50)))
        
        zombies_list.append(zombie_rect1)
        zombies_list.append(zombie_rect2)
